...
BEGIN
	...
	ADDRESS_ID NUMERIC NOT NULL REFERENCES ADDRESS(ADDRESS_ID),
...
BEGIN
	...
	PARKING_LOT_ID NUMERIC NOT NULL REFERENCES PARKING_LOT(PARKING_LOT_ID),
...
BEGIN
	...
	SLOT_NAME VARCHAR(5),
	FLOOR_ID NUMERIC NOT NULL REFERENCES FLOOR(FLOOR_ID),
...
BEGIN
	...
	CUSTOMER_ID NUMERIC NOT NULL REFERENCES CUSTOMER(CUSTOMER_ID),
...
BEGIN
	...
	PAYMENT_ID NUMERIC NOT NULL REFERENCES PAYMENT(PAYMENT_ID),
	PARKING_SLOT_ID NUMERIC NOT NULL REFERENCES PARKING_SLOT(PARKING_SLOT_ID),
	VEHICLE_ID NUMERIC NOT NULL REFERENCES VEHICLE(VEHICLE_ID),
...
BEGIN
	...
	SLOT_BOOKING_ID NUMERIC NOT NULL REFERENCES SLOT_BOOKING(SLOT_BOOKING_ID),
...
BEGIN
	...
	CHECK_IN_ID NUMERIC NOT NULL REFERENCES CHECK_IN(CHECK_IN_ID),
